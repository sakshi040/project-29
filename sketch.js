...
function setup(){
    ...
    block2=new Box(430,235,30,40)
     ...
     block7=new Box(570,235,30,40)

     //level 2
     block8=new Box(410,185,30,40)
    block9=new Box(440,185,30,40)
    block10=new Box(470,185,30,40)
    block11=new Box(500,185,30,40)
